  ...
  return (
    ...
    <div className=" flex bg-yellow-200 w-full h-full items-center justify-between p-11">
        <div className="flex flex-col p-4 gap-2">
          ...
          <div><Type_Animation/></div>
          <div className="text-2xl font-semibold">based on Pune,India.</div>
          <div className="flex gap-7 m-3 justify-start">

            <a  href="#"className="px-6 py-4 hover:bg-slate-800 duration-1000 bg-black text-white font-bold">View My Works</a>
            <a className="text-xl flex underline-offset-1  px-6 py-4 underline" href="#">
             <h4 className="mr-4 font-bold">Contact ME</h4>
              <a href="#">
